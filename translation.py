...
URL | filename | username | password"""
    ...
    SAVEDCUSTOMTHUMBNAIL = "Custom video / file thumbnail saved. This image will be used in the video / file."
    DELETED_CUSTOM_THUMBNAIL = "✅ Custom thumbnail cleared succesfully."
